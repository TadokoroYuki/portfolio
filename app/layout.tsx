...
export const metadata: Metadata = {
  ...
  description: "Next.js と Go を使った Web 開発に情熱を持つフルスタックデベロッパー。モダンな技術で価値あるプロダクトを作ることを目指しています。",
  keywords: ["portfolio", "web developer", "Next.js", "Go", "TypeScript", "full stack", "フロントエンド", "バックエンド"],
